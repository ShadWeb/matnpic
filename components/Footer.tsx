        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-18">
          ...
          <div className="flex-1 max-w-md">
            ...
            <div className="space-y-1 text-sm text-gray-500 dark:text-gray-400">
              <h2>تبدیل متن به عکس آنلاین رایگان</h2>
              <h2>تبدیل متن به عکس آنلاین هوش مصنوعی</h2>
              <h2>تبدیل متن به عکس انلاین</h2>
              <h2>تبدیل متن به عکس فارسی</h2>
              <h2>ربات تبدیل متن به عکس رایگان</h2>
            </div>
          </div>
